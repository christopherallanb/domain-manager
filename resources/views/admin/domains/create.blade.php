...
<div class="rounded-xl border bg-card p-5">
    <h2 class="text-sm font-semibold mb-4">Novo Domínio</h2>
    ...
    <form method="POST" action="{{ route('domains.store') }}">
        ...
        <div class="space-y-4">
            <div>
                ...
                <input type="text" name="name" required class="w-full rounded-md border border-input bg-background px-3 py-2 text-sm" placeholder="meusite.com.br">
            </div>
            ...
            <div>
                ...
                <input type="date" name="expiration_date" required class="w-full rounded-md border border-input bg-background px-3 py-2 text-sm">
            </div>
            
            <div>
                <label class="block text-sm font-medium mb-1">Custo anual (R$)</label>
                <input type="number" name="annual_cost" step="0.01" class="w-full rounded-md border border-input bg-background px-3 py-2 text-sm" placeholder="0.00">
            </div>
